...
devtools::load_all(".")
devtools::load_all("/Users/anthonyfederico/Dropbox/Github/hypeR")
library(tidyverse)
```
...
`r knitr::include_graphics(system.file(package='hyperworkshop', 'vignettes', 'WGCNA-Example.png'))`
...
The data is pre-computed and can be loaded like so....
...
`r knitr::include_graphics(system.file(package='hyperworkshop', 'vignettes', 'Excel-Example.png'))`
...
`r knitr::include_graphics(system.file(package='hyperworkshop', 'vignettes', 'Shiny-Example.png'))`
